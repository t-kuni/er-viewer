import type { BrowserAPIInterface as IBrowserAPIInterface, WindowSize, EventHandler } from '../../types/infrastructure';
/**
 * ブラウザAPI操作の抽象インタフェース
 * prompt、alert、console、window操作などを抽象化
 */
export declare abstract class BrowserAPIInterface implements IBrowserAPIInterface {
    /**
     * プロンプトダイアログを表示
     */
...
//# sourceMappingURL=browser-api-interface.d.ts.map