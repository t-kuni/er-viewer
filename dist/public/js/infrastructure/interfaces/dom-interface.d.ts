 ...
 */
export declare abstract class DOMInterface implements IDOMInterface {
    /**
     * 要素を取得
     */
     ...
     * イベントリスナーを追加
     */
    abstract addEventListener(element: Element, event: string, handler: EventHandler, options?: EventListenerOptions): void;
    /**
     * イベントリスナーを削除
     */
...
//# sourceMappingURL=dom-interface.d.ts.map