...
CREATE TABLE team_members (
    ...
    user_id INT NOT NULL,
    role VARCHAR(20) DEFAULT 'member' CHECK (role IN ('member', 'admin', 'lead')),
...
CREATE TABLE activities (
    id SERIAL PRIMARY KEY,
    user_id INT NOT NULL,
    activity_type VARCHAR(50) NOT NULL CHECK (activity_type IN ('login', 'post_created', 'comment_posted', 'task_completed', 'project_joined')),
    entity_type VARCHAR(20) CHECK (entity_type IN ('user', 'post', 'comment', 'task', 'project')),
    entity_id INT,
    description TEXT,
    metadata JSONB,
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
