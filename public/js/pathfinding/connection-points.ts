...
// Connection points for a relationship
...
export class ConnectionPoints {
  ...
  findOptimalConnectionPoints(
    fromBounds: ConnectionBounds,
    toBounds: ConnectionBounds,
  ...
  private getEntityConnectionPoints(fromBounds: ConnectionBounds, toBounds: ConnectionBounds): ConnectionEndpoints {
    ...
    const edgeKeys = ['top', 'bottom', 'left', 'right'] as const;
  ...
  private getEntityEdgePoints(bounds: ConnectionBounds): Record<'top' | 'bottom' | 'left' | 'right', Position> {
